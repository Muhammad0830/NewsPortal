...
import { useDropzone, type DropzoneOptions as Dropzoneoptions } from "react-dropzone";
...
>(({ dropzoneoptions, width, height, className, disabled, ...props }, ref) => {
  ...
  return (
    <div className="flex flex-col items-center">
      <div
        {...getRootProps({
          className: `${dropZoneClassName} !min-h-0 !min-w-0`,
          style: {
            width,
            height,
          },
      ...
      >
        ...
        {displayUrl ? (
          ...
          >
            <div className="font-medium">{t("click to select")}</div>
            {maxSize && (
